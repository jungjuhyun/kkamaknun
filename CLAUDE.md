...
- **도구가 무엇을 세는지 확인하기 전에는 잰 숫자로도 단정하지 않는다.**
  N5 문법 재고를 재고 "재고 상위 작품과 견인력 큰 작품이 어긋난다"고 결론냈다. 그런데 그 도구는
  ImmersionKit 전용이고 거기엔 라프텔 인기 100위 중 9편밖에 없다 — 원피스·주술회전·체인소맨이
  애초에 후보에 없었다. **재료교차표.txt에 이미 적혀 있던 숫자다.** 표본을 안 보고 순위를 말했다.
  ← 2026-08-20.

- **"된다 된다" 금지.** 안 되면 안 된다고 말한다. 대신 근거 없는 비관도 금지다. 숫자를 댄다.
  **그리고 리스크만 던지고 끝내지 않는다 — 다음 수를 같이 낸다.** "일본행이 종착점이면 채널이 닫힌다"고
  지적만 하고 시즌2를 안 냈다. 불합격도 "설계가 필요하다"고만 했다 — 떨어지면 다시 보면 되는 것이었다.
  한 수 앞만 보면 지적이고, 두 수까지 봐야 기획이다.
  ← 2026-08-20.
...
**단, 이제 답이 레포에 있다 (2026-08-20).** 묻기 전에 [계획.md](계획.md) 1장부터 읽는다.
그리고 **"어느 코너가 주력인가"는 이제 틀린 질문이다.** 코너는 수단이고 축은 성장이다.
파는 것 = 내가 성장하는 것 / 눈금 = JLPT / 애니 쉐도잉 = 성장 수단 1번.
