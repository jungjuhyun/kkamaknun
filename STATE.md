...
- 다음 exact action은 회사 PC에서 최신 authoritative branch를 remote-first로 확인한 뒤 `CORE_D_01`, `CORE_D_02`, `CORE_F_02` evidence의 공통 root-cause를 audit하고, 자동 target 재시험 없이 필요한 공통 remediation 범위를 결정하는 것이다. 그 전에는 Phase 4나 112-trial rerun을 시작하지 않는다.
