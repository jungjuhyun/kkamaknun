...
- 다음 exact action은 corrected common surrogate sequencing으로 영향을 받은 30 valid bootstrap trial과 기존 shortfall 18을 합친 48 valid trial을 동일 snapshot/lane에서 새 release evidence로 측정할지 별도 승인받는 것이다. 현재는 raw archive·historical verdict를 보존하고 Phase 4를 시작하지 않는다.
