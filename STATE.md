...
**콘텐츠 각과 핵심 장면 확정은 실제 진단용 촬영본이 생길 때까지 보류한다.** 현재 확보된 1차·2차 촬영은 촬영 방식과 반응 감을 확인한 자료이며, `레제편을 보면서 일본어가 들린 순간을 멈추고 당시 들린 소리·이해한 뜻을 남긴 뒤 실제 대사와 대조할 수 있는 형태`의 본 촬영은 아직 하지 않았다.

현재 기획 흐름에서 다음으로 이어가기 좋은 단계는 **0화에 사용할 진단용 촬영 프로토콜을 확정하고 실제 촬영본을 확보하는 것**이다.
...
즉 현재 기획상 권장 체크포인트는 **0화 진단용 촬영 프로토콜 확정 → 실제 촬영본 확보**이고, 장면 수집기는 **미완료 보존 작업**이다. 사용자가 다른 작업을 선택하면 그 요청을 우선한다.
