...
2026-09-03: 레제편 **일본어 자막 본문(.ass)을 확보**했고, 1차 촬영본 해석표의 애니 대사 열을 whisper 통과가 아니라 자막 원문으로 다시 구성했다. 결과는 `materials/ep0_take1/ep0_take1_tables_v2.xlsx`와 `materials/ep0_take1/해석표_v2.md`가 owner다. 자막 파일 자체는 저장소에 넣지 않는다.
