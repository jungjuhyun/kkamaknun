...
현재 일본어 성장 방향: **먼저 발달한 청해를 회화와 실제 사용으로 연결한다.**
...
2. 후보를 단순 나열하지 않고 `애니를 오래 보면 자막 없이 실제로 얼마나 들릴까?`라는 겉 질문에 맞게 한 편의 흐름으로 구성한다.
3. 필요한 후보에만 대사 ground truth와 진단을 붙인다.
4. **0화 구성이 잡히면 그 실제 결과와 드러난 병목을 근거로 다음 행동과 다음 편을 기획한다.**
